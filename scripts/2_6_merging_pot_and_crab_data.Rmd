...
# First, clean things up a bit to remove unneeded columns
pot_dat <- pot_dat %>%
  select(-c(Trip.Start.Date, Trip.End.Date, Density.Strata))
...
full_crab_dat <- full_crab_dat[!is.na(full_crab_dat$mean_temp), ]

# Drop irrelevant columns
full_crab_dat <- full_crab_dat %>%
  select(-c(pot_ID, Year.y, Project.y, Trip.No.y, Location.y, Pot.No.y,
            Time.Set, Time.Hauled, Buoy.No, tidbit_id))
