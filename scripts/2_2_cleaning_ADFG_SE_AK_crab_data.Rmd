...
crabdat <- select(crabdat, -Weight.Grams)
```
...
# Nope, let's remove
crabdat <- select(crabdat, -Legal.Size)
```
...
# Yep, remove
crabdat <- select(crabdat, -Leatherback)
```
...
crabdat <- select(crabdat, -Specimen.Comments)
```
...
crabdat <- rename(crabdat, Bitter = Parasite)
