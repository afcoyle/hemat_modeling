...
# Old = 4
# Very Old = 5
crabdat$Shell.Condition <- dplyr::recode(crabdat$Shell.Condition, "Soft" = "1",
                                                       "Light" = "2",
                                                       "New" = "3",
                                                       "Old" = "4",
                                                       "Very Old" = "5")
...
crabdat$Egg.Condition <- dplyr::recode(crabdat$Egg.Condition, "Normal Eggs" = "Normal",
...
crabdat$Egg.Development <- dplyr::recode(crabdat$Egg.Development, "Eyed eggs" = "Eyed", 
                                  "No eggs" = "Barren",
                                  "Uneyed eggs" = "Uneyed")
...
crabdat$Leg.Condition <- dplyr::recode(crabdat$Leg.Condition, "Normal" = "1",
