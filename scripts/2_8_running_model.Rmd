...
lap_eight_mod <- update(lap_seven_mod, Bitter ~ Shell.Condition + s.Temp + s.CW + Blackmat + Leg.Condition + s.Jul.Day + Sex + s.Latitude + (1 | Site) + (1 | s.Year))

# Update the model to include the effect of latitude
lap_nine_mod <- update(lap_eight_mod, Bitter ~ Shell.Condition + s.Temp + s.CW + Blackmat + Leg.Condition + s.Jul.Day + Sex + s.Latitude + s.Depth + (1 | Site) + (1 | s.Year))
